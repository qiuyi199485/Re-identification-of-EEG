...
df_session_second_val = pd.read_excel(session_second_val_path)
df_session_second_test = pd.read_excel(session_second_test_path)
...
session_second_val_epoch_path = os.path.join("D:\\Reidentification", "Epoch_session_second_val")
process_data(df_session_second_val, session_second_val_epoch_path)
print(f"The preprocessed epochs of test set have been saved to {session_second_val_epoch_path}")

# Process and save the session_second subset
session_second_test_epoch_path = os.path.join("D:\\Reidentification", "Epoch_session_second_test")
process_data(df_session_second_test, session_second_test_epoch_path)
print(f"The preprocessed epochs of test set have been saved to {session_second_test_epoch_path}")
